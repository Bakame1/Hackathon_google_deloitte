...
########################################################################################################################################
# TODO : Add remote agents url for creative director and financial analyst agent deployed on Cloud Run and in the A2AToolClient object 
########################################################################################################################################

# CORRECTION 1 : On active l'enregistrement des agents distants
...
# CORRECTION 2 : Sécurisation du log pour éviter l'erreur 403 en local
try:
    logger.log_text(
