...
def generate_image(prompt: str, tool_context: ToolContext) -> dict:
    image_response = genai_client.models.generate_images(
        # Google models available : https://docs.cloud.google.com/vertex-ai/generative-ai/docs/models 
...
##############################################################################################################################
# TODO : Create a sequential agent and pass following agents as sub agents in sequence:
...
creative_director_agent = SequentialAgent(
    ...
    # sub_agents=[TODO sub agents TODO],        
