...
##############################################################################################################################
# TODO : Load toolset named my_bq_toolset you created as part of MCP toolbox.
##############################################################################################################################

# CORRECTION 1 : Chargement du toolset défini dans le YAML
tools = toolbox.load_toolset('my_bq_toolset')

###################################################################################################################################
# TODO : Create an agent with "gemini-2.5-pro" model to fetch the demographic data from BigQuery using the tools defined above 
###################################################################################################################################

data_analyst_agent = Agent(
    # CORRECTION 2 : Définition du modèle exact demandé
...
Return only the JSON object. Do not include any other explanatory text or content.
    ...
    # CORRECTION 3 : Injection des outils chargés
    tools=tools,
)
